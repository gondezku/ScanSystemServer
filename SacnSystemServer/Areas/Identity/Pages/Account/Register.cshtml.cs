...
namespace SacnSystemServer.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required(ErrorMessage = "Which BU you belong it?")]
            public string BU_Unit { get; set; }
            public IEnumerable<SelectListItem> BU_List { get; set; }

            [Required(ErrorMessage = "Which Role is you want it?")]
            public string Role { get; set; }
            public IEnumerable<SelectListItem> Role_List { get; set; }

            [Required(ErrorMessage = "Who're you pal...")]
        ...
        {
            if (!_roleManager.RoleExistsAsync(Roles.Role_Manager).GetAwaiter().GetResult())
            {
            ...
            {
                Role_List = _roleManager.Roles.Select(x => x.Name).Select(i => new SelectListItem
                {
                    Text = i,
                    Value = i
            ...
            {
                BU_List = _db.BUnits.Select(i => new SelectListItem
                {
                    Text = i.Name,
                    Value = i.Id
                })
